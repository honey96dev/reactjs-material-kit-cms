      ...
      <div className={classes.container}>
        ...
        <div className={classes.features2}>
          <GridContainer>
            ...
            >
              <h2 className={classes.title}>Network & Connect</h2>
              <h5 className={classes.description}>
              </h5>
            </GridItem>
          </GridContainer>
            ...
            <GridItem xs={12} sm={4} md={4}>
              <InfoArea
                ...
                description={
                  <span>
                    <p>
                    Network with other teams to share knowledge and grow.
                    </p>
            ...
            <GridItem xs={12} sm={4} md={4}>
              <InfoArea
                ...
                description={
                  <span>
                    <p>
                    Network with teams for new opportunities.
                    </p>
                    <a href="#pablo" onClick={e => e.preventDefault()}>
                      Find more...
                    </a>
            ...
            <GridItem xs={12} sm={4} md={4}>
              <InfoArea
                ...
                description={
                  <span>
                    <p>
                    Working in a team is more fun and better than working alone.
                    </p>
                    <a href="#pablo" onClick={e => e.preventDefault()}>
                      Find more...
                    </a>
